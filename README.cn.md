...
[![x-cmd/install — grex Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/grex.svg?lang=zh)](https://x-cmd.com/install/grex)
...
| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Rust | 10,913 | 463 | 969 | 27 |
| Python | 281 | 15 | 44 | 1 |
| Toml | 82 | 14 | 16 | 2 |
| Markdown | 0 | 545 | 237 | 3 |
| Text | 0 | 52 | 0 | 2 |
...
- **上游仓库**: <https://github.com/pemistahl/grex>
- **官网**: <https://pemistahl.github.io/grex-js/>
- **许可证**: Apache-2.0

## 发布

- **最新版本**: `v1.4.6` (2025-11-14)
- **最近提交**: 2026-01-14
- **Release 含资产**: 6 个

## 流行度

- **Star**: 8,197 · **Fork**: 198 · **开放 issue**: 59 · **贡献者**: 9

## 累计统计

- **发布数**: 16 · **已合并 PR**: 177 · **开放 PR**: 11 · **已关闭 issue**: 51 · **开放 issue**: 8 · **提交数**: 445
...
| 360d | 2025-09-29 | 1 | 7 | 10 | 2 | 0 | 21 |
| last720d | 2024-10-04 | 1 | 16 | 11 | 6 | 0 | 39 |
...
grex 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `grex` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/grex.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T04:54:22Z._
